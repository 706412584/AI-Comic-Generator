...
.tip-text { color: var(--app-text-secondary); font-size: 0.85em; }
.warning-text { color: #E6A23C; font-size: 0.85em; display: inline-flex; align-items: center; gap: 4px; }
.text-gray { color: var(--app-text-secondary); }
